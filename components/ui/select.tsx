...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "bg-white rounded-full text-neutral-900 font-semibold flex w-full items-center justify-between border border-slate-200 py-2 text-sm ring-offset-white data-[placeholder]:text-slate-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 h-14 px-6 min-h-14",
      className,
    )}
    {...props}
  >
